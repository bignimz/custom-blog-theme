...
<head>
    ...
    <link rel="shortcut icon" href="wp-content/themes/wp-blog23/assets/images/logo.png"> 
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<?php
					...
					$args = array(
						...
						'container' => '',
						'items_wrap' => '<ul id="%1$s" class="navbar-nav flex-column text-sm-center text-md-left">%3$s</ul>'
					);
